    ...
    <div style={{ background: "#0a0e1a", minHeight: "100vh", color: "#fff" }}>
      ...
      <main style={{ maxWidth: 800, margin: "0 auto", padding: "56px 28px" }}>
        <div className="legal-content">
          ...
          <p>Správcem osobních údajů je <strong>SAY TO PAY s.r.o.</strong> (dále jen „Správce"), provozovatel služby AIBaimy. Kontakt pro ochranu osobních údajů: <strong>info@aiblab.info</strong>.</p>
          ...
          <p>Žádosti o uplatnění práv zasílejte na: <strong>info@aiblab.info</strong>. Odpovíme do 30 dnů.</p>
        </div>
      </main>
